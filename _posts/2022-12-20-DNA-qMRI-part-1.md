...
<center> <img src="{{ site.baseurl }}/assets/images/DNA_qMRI-02.png" style="border: 3px solid red"/> </center>
...
<img src="{{ site.baseurl }}/assets/images/DNA_qMRI-03.png"/>**Fig. 1** – Major Human Genome Project publications (Source: [HGP Overview Slides](https://www.genome.gov/human-genome-project)).
...
<img src="{{ site.baseurl }}/assets/images/DNA_qMRI-05.png"/>**Fig. 3** – [Structure of DNA](https://theory.labster.com/structure-dna/).
...
<img src="{{ site.baseurl }}/assets/images/DNA_qMRI-06.png"/>**Fig. 4** – The parallel between DNA sequencing and qMRI. Image sources: [top left](https://www.theguardian.com/science/2022/mar/31/first-complete-gap-free-human-genome-sequence-published),[bottom left](https://www.gettyimages.com/detail/photo/blue-chromosome-dna-and-gradually-glowing-flicker-royalty-free-image/1297146235?adppopup=true), top center and top right brain images from [Karakuzu et al. 2022](https://onlinelibrary.wiley.com/doi/10.1002/mrm.29292).
...
<img src="{{ site.baseurl }}/assets/images/DNA_qMRI-07.png"/>**Fig. 5** – Excerpt from the Siemens MAGNETOM Skyra fit Operator’s Manual; referenced in a [talk by Dr. Nikola Stikov](https://youtu.be/eaaHY_nl7tA?t=740).
